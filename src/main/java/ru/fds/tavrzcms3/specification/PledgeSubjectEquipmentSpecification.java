...
public class PledgeSubjectEquipmentSpecification implements Specification<PledgeSubjectEquipment> {

    private SearchCriteria criteria;

    public PledgeSubjectEquipmentSpecification(SearchCriteria searchCriteria){
        criteria = searchCriteria;
    }

    @Override
    public Predicate toPredicate(Root<PledgeSubjectEquipment> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
