...
public class PledgeSubjectRealtyBuildingSpecification implements Specification<PledgeSubjectRealtyBuilding> {

    private SearchCriteria criteria;

    public PledgeSubjectRealtyBuildingSpecification(SearchCriteria searchCriteria){
        criteria = searchCriteria;
    }

    @Override
    public Predicate toPredicate(Root<PledgeSubjectRealtyBuilding> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
