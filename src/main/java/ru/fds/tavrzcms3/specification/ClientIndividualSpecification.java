...
public class ClientIndividualSpecification implements Specification<ClientIndividual> {

    private SearchCriteria criteria;

    public ClientIndividualSpecification(SearchCriteria searchCriteria){
        criteria = searchCriteria;
    }

    @Override
    public Predicate toPredicate(Root<ClientIndividual> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
