...
public class PledgeSubjectTBOSpecification implements Specification<PledgeSubjectTBO> {


    private SearchCriteria criteria;

    public PledgeSubjectTBOSpecification(SearchCriteria searchCriteria){
        criteria = searchCriteria;
    }

    @Override
    public Predicate toPredicate(Root<PledgeSubjectTBO> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
