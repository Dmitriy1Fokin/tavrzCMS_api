...
public class PledgeSubjectSpecification implements Specification<PledgeSubject> {

    private SearchCriteria criteria;

    public PledgeSubjectSpecification(SearchCriteria searchCriteria){
        criteria = searchCriteria;
    }

    @Override
    public Predicate toPredicate(Root<PledgeSubject> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
