...
public class PledgeSubjectRealtyRoomSpecification implements Specification<PledgeSubjectRealtyRoom> {


    private SearchCriteria criteria;

    public PledgeSubjectRealtyRoomSpecification(SearchCriteria searchCriteria){
        criteria = searchCriteria;
    }

    @Override
    public Predicate toPredicate(Root<PledgeSubjectRealtyRoom> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
