...
public class PledgeSubjectRealtyLandOwnershipSpecification implements Specification<PledgeSubjectRealtyLandOwnership> {

    private SearchCriteria criteria;

    public PledgeSubjectRealtyLandOwnershipSpecification(SearchCriteria searchCriteria){
        criteria = searchCriteria;
    }

    @Override
    public Predicate toPredicate(Root<PledgeSubjectRealtyLandOwnership> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
