...
public class ClientLegalEntitySpecification implements Specification<ClientLegalEntity> {

    private SearchCriteria criteria;

    public ClientLegalEntitySpecification(SearchCriteria searchCriteria){
        criteria = searchCriteria;
    }

    @Override
    public Predicate toPredicate(Root<ClientLegalEntity> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
