...
public class PledgeSubjectAutoSpecification implements Specification<PledgeSubjectAuto> {

    private SearchCriteria criteria;

    public PledgeSubjectAutoSpecification(SearchCriteria searchCriteria){
        criteria = searchCriteria;
    }

    @Override
    public Predicate toPredicate(Root<PledgeSubjectAuto> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
