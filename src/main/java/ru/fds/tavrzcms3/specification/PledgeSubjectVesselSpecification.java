...
public class PledgeSubjectVesselSpecification implements Specification<PledgeSubjectVessel> {


    private SearchCriteria criteria;

    public PledgeSubjectVesselSpecification(SearchCriteria searchCriteria){
        criteria = searchCriteria;
    }

    @Override
    public Predicate toPredicate(Root<PledgeSubjectVessel> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
