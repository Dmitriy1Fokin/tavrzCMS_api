...
public class PledgeAgreementSpecification implements Specification<PledgeAgreement> {

    private SearchCriteria criteria;

    public PledgeAgreementSpecification(SearchCriteria searchCriteria){
        criteria = searchCriteria;
    }

    @Override
    public Predicate toPredicate(Root<PledgeAgreement> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
