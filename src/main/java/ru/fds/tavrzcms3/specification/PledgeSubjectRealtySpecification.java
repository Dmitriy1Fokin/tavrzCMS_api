...
public class PledgeSubjectRealtySpecification implements Specification<PledgeSubjectRealty> {
    private SearchCriteria criteria;

    public PledgeSubjectRealtySpecification(SearchCriteria searchCriteria){
        criteria = searchCriteria;
    }

    @Override
    public Predicate toPredicate(Root<PledgeSubjectRealty> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
