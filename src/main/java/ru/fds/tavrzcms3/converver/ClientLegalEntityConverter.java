...
@Component
public class ClientLegalEntityConverter implements Converter<ClientLegalEntity, ClientLegalEntityDto> {
    ...
    public ClientLegalEntityConverter(ClientManagerService clientManagerService,
