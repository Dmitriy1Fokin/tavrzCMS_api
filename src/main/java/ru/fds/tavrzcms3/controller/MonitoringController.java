...
public class MonitoringController {
    ...
    public MonitoringDto getMonitoringById(@PathVariable("monitoringId") Long monitoringId){
        return monitoringService.getMonitoringById(monitoringId)
                .map(dtoFactory::getMonitoringDto)
                .orElseThrow(()-> new NotFoundException("Monitoring not found"));
    }
